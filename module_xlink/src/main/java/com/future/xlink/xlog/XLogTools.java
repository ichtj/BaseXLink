...
import com.future.xlink.xlog.DefaultFlattener;
import com.future.xlink.xlog.CustomGenerator;
...
public class XLogTools {
     ...
     * 初始化时创建配置文件
     */
    public static void initXLog(String xlogPath) {
        ...
        Printer filePrinter = new FilePrinter                       // 打印日志到文件的打印器
                ...
                .fileNameGenerator(new CustomGenerator())        // 指定日志文件名生成器，默认为 ChangelessFileNameGenerator("log")
